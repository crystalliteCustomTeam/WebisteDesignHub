...
const Sidebuttons = () => {
    ...
    return (
        ...
        <>
            ...
            <Link href="tel:0346-8280111" className="cursor-pointer hidden lg:flex items-center rounded-tl-[50px] rounded-bl-[50px] py-2 px-4 gap-4 translate-x-[75%] hover:translate-x-[1%] bg-[#0F2847] fixed top-[33%] right-0 z-50">
                <Image src={call} alt="call" />
                <span className="text-white font-semibold text-lg">0346-8280111</span>
            </Link>
