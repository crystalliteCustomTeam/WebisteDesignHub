                ...
                <div className="container">
                    <div className="flex">
                        <div className="basis-full">
                            ...
                            <p className="text-base text-[#202020] font-normal text-center mb-10">Web Developers Hub has an In-house team of devoted professional web designers and developers, <br className="hidden md:block" /> who are dedicated  to delivering top-tier websites for businesses. <br className="hidden md:block" /> Our website solutions include:</p>
