...
const page = () => {
    return (
        <main>
            ...
            <WhyHire
                span="Why Hire Us?"
                title={`What Makes <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#eb335b] to-[#4a78ef]">Bitswits The Most Recommended <br class="xl:block hidden"/> Mobile App Development</span>  Company?`}
