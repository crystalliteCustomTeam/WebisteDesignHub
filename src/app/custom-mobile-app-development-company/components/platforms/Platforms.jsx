                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 items-center text-white font-sans mt-10">
                    {
                        [
                            [`Hybrid <br /> <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#eb335b] to-[#4a78ef]">App Development</span>`,
                                "Web Developers Hub take pride in developing hybrid apps that are visually stunning and perform exceptionally well. Our team of skilled hybrid app developers leverages the latest technologies to create fast, secure, and user-friendly apps, ensuring your business stays ahead of the curve with:"
                                , hybrid, [
