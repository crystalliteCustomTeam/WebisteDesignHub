...
const Services = () => {
    ...
    const portfolioData = [
        ...
        },
        {
            ...
            images: [service4],
            desc: "Make your mark on the web with Web Developers Hub, the web app development company that understands your vision. Our web app solutions are designed for impact, ensuring you make the right impression. Our web app developers are here to turn your dream into a digital reality."
        },
        {
            value: "custom",
            ...
            <div className="bg-[#000000] xl:py-[80px] lg:py-[60px] py-[40px]">
                <div className="container">
                    <div className="font-sans text-center text-white">
                        ...
                        <p className="md:text-base text-sm leading-normal font-normal">At Web Developers Hub, our expert team specializes in professional app development. Whether you want to build an app from scratch or make an <br className="xl:block hidden" /> app that stands out, we're here to turn your ideas into reality.</p>
                    </div>
