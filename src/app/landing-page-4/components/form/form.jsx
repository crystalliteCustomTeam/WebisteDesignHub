                    ...
                    <div className="">
                        <form autoComplete="off">
                            <div className="grid grid-cols-1 gap-5 mt-5">
                                ...
                                <div>
                                    <input type="button" onClick={handleFormSubmit} className="text-sm sm:text-lg font-medium pr-8 pl-8 h-11 rounded-md bg-[#9E4BFF] w-full text-white cursor-pointer" value={formStatus} />
                                </div>
                            </div>
                        </form>
                    </div>
