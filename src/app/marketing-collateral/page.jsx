...
const Page = () => {
    ...
    const hero = {
        ...
        desc: "Urban Web Designers has the greatest content writers and marketers in the business, so you can count on them to create engaging material and distribute it effectively to retain and grow your consumer base.",
    ...
    const smallbanner = {
        ...
        bgColor: "bg-[#FF7489]",
        btnBg: "bg-[#FFABBA]",
        btnBorder: "border-[#FFABBA]",
        btnHover: "hover:bg-[#FFABBA]",
        theme: "dark"
    };
